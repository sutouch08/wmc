...
<div class="nav-title nav-title-center">
	...
	<div class="font-size-18 text-center">เพิ่ม ข้อมูลลูกค้า</div>
</div>
	...
	<div class="form-horizontal page-wrap full">
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<input type="text" class="form-control r" id="name" placeholder="ชื่อลูกค้า" autocomplete="off"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<textarea class="form-control r" rows="2" id="address"></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right">เบอร์โทร</label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<input type="text" class="form-control r" id="phone" placeholder="เบอร์โทรศัพท์" autocomplete="off"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<input type="text" class="form-control" id="map" autocomplete="off"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<input type="text" class="form-control r" id="contact" placeholder="ชื่อผู้ติดต่อ" autocomplete="off"/>
			</div>
		</div>
