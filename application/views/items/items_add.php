	...
	<div class="form-horizontal page-wrap full">
		<div class="form-group">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<input type="text" class="form-control" id="code" onkeyup="validCode(this)"  placeholder="allow a-z A-Z - _" autofocus autocomplete="off" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 col-xs-12 control-label no-padding-right">ชื่อสินค้า</label>
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<input type="text" class="form-control r" id="name" autocomplete="off"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<input type="number" class="form-control" id="price" value="0" autocomplete="off"/>
			</div>
		</div>
