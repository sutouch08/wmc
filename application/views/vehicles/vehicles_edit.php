	...
	<div class="form-horizontal page-wrap full">
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="text" class="form-control r" id="code" value="<?php echo $ds->code; ?>" autocomplete="off" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<select class="form-control r" id="type">
					...
					<?php echo select_vehicle_type($ds->type); ?>
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<input type="number" class="form-control" id="pallet" value="<?php echo $ds->pallet; ?>" autocomplete="off"/>
			</div>
		</div>
